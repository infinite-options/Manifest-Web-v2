...
export default function Firebasev2(props) {
  ...
  function cleanData(historyGot, useDate) {
    ...
    for (var i = 0; i < historyGot.length; i++) {
      ...
      console.log(
        ...
        historyDate,
        useDate,
        useDate.getTime() - 604800000
      );
      if (
        historyDate.getTime() >=
        useDate.getTime() - 604800000 //filter for within 7 datets
                    ...
                    if (insts[i].title) {
                      ...
                      for (var s = 0; s < bigList.length; s++) {
                        if (
                          ...
                          bigList[s].id == insts[i].instruction
                        ) {
  ...
  function makeDisplays(onlyAllowed) {
    ...
    for (var i = 0; i < onlyAllowed.length; i++) {
      if (onlyAllowed[i].type == 'Routine') {
        ...
        tempRows.push(displayInstructions(onlyAllowed[i], action));
      }
    }
  ...
  function displayActions(a, r) {
    return (
      <div style={{ backgroundColor: '#d1dceb', marginBottom: '0px' }}>
        <div style={{ display: 'flex', justifyContent: 'space-evenly' }}>
          ...
          <div style={{ display: 'flex', marginTop: '1rem' }}>
            ...
            >
              <div>
                <EditActionIcon routine={a} task={r.id} step={null} />
              </div>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-evenly' }}>
          ...
          <div style={{ display:"flex" , marginTop:'1rem'}}>
            ...
            >
              ...
              <EditStepsIcon routine={i} task={null} step={a.id} />
            </div>
          </div>
        </div>
      </div>
