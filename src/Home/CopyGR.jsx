          ...
          {this.state.copyType === 'fromta' ? (
            <>
              <DropdownButton
                ...
                style={{ marginTop: '10px' }}
                title={
                  this.state.currentAdvisorCandidateName || 'Choose the advisor'
                }
              >
              ...
              <DropdownButton
                variant="outline-primary"
                style={{ marginTop: '10px' }}
                title={this.state.currentUserCandidateName || 'Choose the User'}
              >
                {Object.keys(this.state.userNames).map((keyName, keyIndex) => (
                  <Dropdown.Item
                    key={keyName}
                    onClick={(e) => {
