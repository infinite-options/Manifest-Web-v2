...
export default class AddIconModal extends Component {
  ...
  render() {
    ...
    for (let i = 0; i < this.state.iconList1.length; i++) {
      arrButtonsHygiene.push(
        <button onClick={(e) => this.onPhotoClick(this.state.iconList1[i].url)}>
          <img
            height="70px"
            width="70px"
    ...
    for (let i = 0; i < this.state.iconList2.length; i++) {
      arrButtonsClothing.push(
        <button onClick={(e) => this.onPhotoClick(this.state.iconList2[i].url)}>
          <img
            height="70px"
            width="70px"
    ...
    for (let i = 0; i < this.state.iconList3.length; i++) {
      arrButtonsFood.push(
        <button onClick={(e) => this.onPhotoClick(this.state.iconList3[i].url)}>
          <img
            height="70px"
            width="70px"
    ...
    for (let i = 0; i < this.state.iconList4.length; i++) {
      arrButtonsActivities.push(
        <button onClick={(e) => this.onPhotoClick(this.state.iconList4[i].url)}>
          <img
            height="70px"
            width="70px"
    ...
    for (let i = 0; i < this.state.iconList5.length; i++) {
      arrButtonsOther.push(
        <button onClick={(e) => this.onPhotoClick(this.state.iconList5[i].url)}>
          <img
            height="70px"
            width="70px"
