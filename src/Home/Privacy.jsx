  ...
  return (
    ...
    >
      ...
      >
        ...
        <br />
        <div className={classes.body}>Last updated: June 22, 2020 </div>
        <br />
        ...
        <div>
          ...
          <div className={classes.body}>
            ...
            assistance navigating their day. <br /> The Trusted Advisor is
            defined as a person who has a vested interest in the health and well
            being of the User.
          </div>
        </div>
        <br />
        <div>
          ...
          <div className={classes.body}>
            ...
            application provides assistance identifying Goals, Routines and
            Events that may be significant in the User’s life. <br />
            ...
            User. <br />
            We use both the User’s and Trusted Advisor’s Personal Information
            only for providing and improving the web application. By using
            either application, you agree to the collection and use of
        ...
        <div>
          ...
          <div className={classes.body}>
            ...
            Trusted Advisor will have access to the Users Google Calendar and
        ...
        <div>
          ...
          <div className={classes.body}>
            Like many application operators, we collect information that your
            web phone sends whenever you visit our web application ("Log Data").{' '}
            ...
            Analytics that collect, monitor and analyze this information to
        ...
        <div>
          ...
          <div className={classes.body}>
            ...
            information regarding the web application.
          </div>
        </div>
        <br />
        <div>
        ...
        <div>
          ...
          <div className={classes.body}>
            ...
            by placing a prominent notice on our web application.
          </div>
        </div>
        <br />
        <div>
