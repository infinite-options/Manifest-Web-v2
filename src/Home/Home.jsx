...
export default function Home() {
  ...
  const [currentUserTimeZone, setCurrentUserTimeZone] = useState({
    currentUserTimeZone: Intl.DateTimeFormat().resolvedOptions().timeZone, // decides which type of calendar to display
  });
                ...
                <Col>
                  <div>
                    ...
                    >
                      ...
                      {stateValue.dateContext.format('dddd')} {getDay()}{' '}
                      {getMonth()}
                      {getYear()}
                    </p>
                    <p
