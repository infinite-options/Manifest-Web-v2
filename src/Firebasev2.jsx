...
const FirebaseV2 = (props) => {
  ...
  //       let date = moment(this.props.goals[i]["end_day_and_time"]).format(
  //         "MM/DD/YYYY"
  //       );
  //       displayGoals.push(
  //         <div key={"test1" + i}>
  ...
  */
    ...
    return (
      ...
      >
        ...
        <Modal.Body>
          ...
          >
            {setStateValue.addNewGRModalShow ? AddNewGRModalAbstracted() : ""}
          </div>
          <div
            style={{
              borderRadius: "15px",
  ...
  //       ATArray={this.props.originalGoalsAndRoutineArr} //Holds the raw data for all the is in the single action
  //       refresh={grabFireBaseRoutinesGoalsData}
  //       isRoutine={setStateValue.isRoutine}
  //       width={this.state.modalWidth}
  //       todayDateObject={this.props.todayDateObject}
  //       theCurrentUserId={this.props.theCurrentUserID}
  //       theCurrentTAID={this.props.theCurrentTAID}
  //       singleGR={setStateValue.singleGR}
  //       BASE_URL={this.props.BASE_URL}
  //     />
  //   );
  // };
      ...
      <userContext.Provider value={(stateValue.showCopyModal, setStateValue)}>
        ...
        {props.showRoutine ? (
          ...
          >
            ...
            {/* {console.log('Displaying...', displayRoutines)} */}
          </Col>
        ) : (
          <div>
            {/* {console.log('showRoutine not showing:', props.showRoutine)} */}
          </div>
        )}
