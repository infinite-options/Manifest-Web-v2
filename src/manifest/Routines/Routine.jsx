...
export default function Routine(props) {
  ...
  function handleAction() {
    props.itemId.map((item) => {
      axios
        .get(BASE_URL + 'actionsTasks/' + item.toString())
        .then((response) => {
  ...
  return (
    <Box display="flex" marginTop="2%">
      <Box flex="1">
        <Box
          style={{ backgroundColor: '#FF6B4A', borderRadius: '15px' }}
          height="4rem"
        >
      ...
      <Box flex="1">
        <Box
          style={{ backgroundColor: '#F8BE28', borderRadius: '15px' }}
          height="4rem"
        >
          <Box paddingTop="2rem" paddingLeft="6rem">
            Action
      ...
      <Box flex="1">
        <Box
          style={{ backgroundColor: '#67ABFC', borderRadius: '15px' }}
          height="4rem"
        >
          <Box paddingTop="2rem" paddingLeft="6rem">
            Steps
