      ...
      >
        ...
        <Form.Group>
          <div style={{display:'flex' , justifyContent:'space-between'}}>
            ...
            <Form.Label style={{fontWeight:'bold', display:'flex', color:'#ffffff', marginTop:'1rem'}}> Change Icon </Form.Label>
        ...
        <div style={{ marginTop: "20px" }}>
          <label style={{fontWeight:'bold', display:'flex', color:'#ffffff', marginTop:'1rem'}}>This Takes Me</label>
          <Row>
        ...
        <div>
          <label style={{fontWeight:'bold', display:'flex', color:'#ffffff', marginTop:'1rem'}}>Repeating Options</label>
          <DropdownButton
        ...
        <div className="input-group mb-3" style={{ marginTop: "10px", display:'flex', justifyContent:'space-between' }}>
          <div>
          <label className="form-check-label" style={{fontWeight:'bold', color:'#ffffff', marginTop:'1rem'}}>Available to the user</label>
          </div>
          <div>
          <input
            style={{ marginTop: "5px", marginLeft: "5px", borderRadius:'10px', width:'1rem', height:'1rem' }}
            name="Available"
            type="checkbox"
