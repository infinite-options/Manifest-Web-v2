    ...
    return (
      <div>
        <Form.Group controlId="Notification">
          <Row >
          <label style={{display:'flex' , fontWeight:'bold', color:'#ffffff', marginTop:'1rem'}}> Notifications </label>
            ...
            <Col style={{ paddingRight: "0px" }}>
              ...
              <Form.Control
                type="number"
                placeholder=""
                style={{ width: "70px", marginTop: ".25rem" , borderRadius:'5px'}}
            ...
            <Col xs={8} style={{ paddingLeft: "0px", fontWeight:'bold', color:'#ffffff' }}>
          ...
          <Row style={{ marginTop: "15px" }}>
            <div style={{display:'flex' , justifyContent:'space-evenly'}}>
            <Col style={{ paddingRight: "0px" }}>
              <Form.Text style={{  fontSize:'65%', fontWeight:'bold', color:'#ffffff' }}> User</Form.Text>
            </Col>
            <Col xs={8}>
          ...
          <div style={{display:'flex' , justifyContent:'space-evenly'}}>
            <Col style={{ paddingRight: "0px" }}>
              <Form.Text style={{ fontSize: "65%", fontWeight:'bold', color:'#ffffff', marginLeft:'0.5rem'}}> TA</Form.Text>
            </Col>
            <Col xs={8}>
              <Form.Check type="checkbox" style={{ paddingLeft: "0px" }}>
                <Form.Check.Input
          ...
          <div style={{display:"flex" , justifyContent:'space-evenly'}}>
            ...
            <Col xs={8} style={{ paddingLeft: "0px" }}>
              <Form.Text style={{ fontSize: "65%",fontWeight:'bold', color:'#ffffff' }}>
                {" "}
          ...
          <div style={{display:"flex" , justifyContent:'space-evenly'}}>
            <Col style={{ paddingRight: "0px" }}>
              <Form.Text style={{ fontSize: "65%",fontSize: "65%", fontWeight:'bold', color:'#ffffff' , marginLeft:'0.5rem'}}> TA</Form.Text>
            </Col>
            <Col xs={8}>
              <Form.Check type="checkbox" style={{ paddingLeft: "0px" }}>
                <Form.Check.Input
